...
def parse_args_and_config():
    ...
    # ninwang
    parser.add_argument('--compare_diff_pre', action='store_true')
    ...
    parser.add_argument('--diff_type', type=str, default=None, help='ninwang: orig/xlat/xid.')
    parser.add_argument('--diff_is_forward', action='store_true', help='ninwang: True then process forward process, else False.')
    ...
    elif args.compare_diff or args.compare_diff_pre:
        args.exp = args.exp + f'_CD_{new_config.data.category}_{args.folder_path.split("/")[-1]}_nit{args.n_iter}_t{args.t_0}_ninv{args.n_inv_step}_ngen{args.n_test_step}'
...
def main():
    ...
    try:
        ...
        elif args.compare_diff_pre:
            runner.clip_compare_diff_pre()
